...
config.bind(',n', 'spawn --detach mpv --ytdl-raw-options=no-check-certificates= {url}')
config.bind(',N', 'hint links spawn --detach mpv --ytdl-raw-options=no-check-certificates= {hint-url}')

# Slightly larger tab bar.
