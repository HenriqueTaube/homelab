...
add_body(doc, f'A presente proposta contempla o fornecimento de {TITULO_ITEM01}, para aplicação na operação de {CLIENTE_NOME}.')
...
for item in [
    '[Recurso operacional 01]',
    '[Recurso operacional 02]',
    '[Recurso operacional 03]',
]:
...
for item in [
    '[Benefício operacional 01]',
    '[Benefício operacional 02]',
    '[Benefício operacional 03]',
]:
    add_body(doc, item, bullet=True)
doc.add_paragraph()
...
add_heading(doc, '7. Dados Complementares')
add_kv_table(doc, [
    ('Frete',                   'FOB'),
...
out = f'/home/henrique/projetos/editor/proposta/models/MODELO 1 ITEM.docx'
doc.save(out)
